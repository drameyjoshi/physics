...
\frac{1}{2\pi}\int_{-\infty}^\infty e^{-i(\omega - \omega^\op)t}dt = \delta(\omega - \omega^\op)
\end{equation}
we get
\[
...
\vec{H} &=& -2\sqrt{\frac{\pi}{V}}\sum_\vec{k}
     \frac{ck\vec{k} \times \vec{Q}_\vec{k}\sin(\vec{k}\cdot\vec{r}) + \vec{k} \times \vec{P}_\vec{k}\cos(\vec{k}\cdot\vec{r})}{k} \label{c6e148}
\end{eqnarray*}
\end{enumerate}