...
If $\varphi = 1/R$ then
\[
\pdt{\varphi}{x_i} = -\frac{x_i}{R^3}
\]
and
\[
\frac{\partial^2 \varphi}{\partial x_j\partial x_i} = -\frac{\delta_{ij}}{R^3} + 3\frac{x_ix_j}{R^5}
= \frac{3x_ix_j - R^2\delta_{ij}}{R^5}.
\]
so that
\[
U^{(2)} = \frac{1}{2}\sum_a q_a r_{ai}r_{aj}\frac{3x_ix_j - R^2\delta_{ij}}{R^5}.
\]
\end{enumerate}
