...
\end{equation}
so that
\begin{equation}\label{c4e79}
\delta\Lambda = -\frac{1}{8\pi}F^{\mu\nu}(\delta\partial_\mu A_\nu - \delta\partial_\nu A_\mu)
\end{equation}
Interchanging indices,
\[
\delta\Lambda = -\frac{1}{8\pi}F^{\nu\mu}(\delta\partial_\nu A_\mu - \delta\partial_\mu A_\nu).
\]
Using the anti-symmetric nature of the electromagnetic stress tensor,
\begin{equation}\label{c4e80}
\delta\Lambda = \frac{1}{8\pi}F^{\mu\nu}(\delta\partial_\nu A_\mu - \delta\partial_\mu A_\nu)
\end{equation}
Adding \eqref{c4e79} and \eqref{c4e80}, we get
\begin{equation}\label{c4e81}
\delta\Lambda = \frac{1}{4\pi}F^{\mu\nu}\delta\partial_\mu A_\nu.
\end{equation}
