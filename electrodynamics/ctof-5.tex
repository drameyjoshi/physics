...
or
\[
f^\op = \sqrt{\frac{1}{c^2}\left(\mathcal{E} - \frac{\alpha}{r}\right)^2 - \frac{L^2}{r^2} 
-m^2c^2}
\]
The solution, thus, is
\begin{equation}\label{c5e69}
S(r, \phi, t) = -\mathcal{E}t + L\phi + 
\frac{1}{c}\int\sqrt{\left(\mathcal{E}-\frac{\alpha}{r}\right)^2-\frac{L^2c^2}{r^2} -m^2c^4}dr
\end{equation}

We will consider three cases:
\begin{enumerate}
\item $Lc > |\alpha|$ so that the integrand becomes,
\begin{eqnarray*}
\sqrt{\left(\mathcal{E}-\frac{\alpha}{r}\right)^2-\frac{L^2c^2}{r^2} -m^2c^4}
 &=& \sqrt{\mathcal{E}^2 - 2\mathcal{E}\frac{\alpha}{r}-\frac{L^2c^2 - \alpha^2}{r^2}-m^2c^4} \\
 &=& \frac{\sqrt{(\mathcal{E}^2-m^2c^4)r^2 -2\mathcal{E}\alpha r - (L^2c^2 - \alpha^2)}}{r} \\
 &=& \frac{\sqrt{A^2r^2 - 2Br - C^2}}{r},
\end{eqnarray*}
where
\begin{eqnarray}
A^2 &=& \mathcal{E}^2-m^2c^4 \label{c5e70} \\
B   &=& \mathcal{E}\alpha \label{c5e71} \\
C^2 &=& L^2c^2 - \alpha^2 \label{c5e72}
\end{eqnarray}
Now,
\begin{eqnarray}
\int\frac{\sqrt{Ar^2 - 2Br - C^2}}{r}dr &=& \sqrt{Ar^2-2Br-C^2} - \nonumber\\
 & & C\tan^{-1}\left(\frac{-Br^2-C^2}{C\sqrt{Ar^2-2Br-C^2}}\right) - \nonumber\\
 & & \frac{B}{A}\tanh^{-1}\left(\frac{Ar^2 - B}{A\sqrt{Ar^2-2Br-C^2}}\right). \nonumber\\
 \label{c5e73}
\end{eqnarray}

\item $Lc > |\alpha|$ leads to
\begin{eqnarray}
\int\frac{\sqrt{Ar^2 - 2Br + C^2}}{r}dr &=& \sqrt{Ar^2-2Br+C^2} - \nonumber\\
 & & C\tan^{-1}\left(\frac{-Br^2+C^2}{C\sqrt{Ar^2-2Br+C^2}}\right) - \nonumber\\
 & & \frac{B}{A}\tanh^{-1}\left(\frac{Ar^2-B}{A\sqrt{Ar^2-2Br+C^2}}\right). \nonumber\\
...
\int\frac{\sqrt{Ar^2 - 2Br}}{r}dr = \frac{2B}{A}\sinh^{-1}\left(A\sqrt{\frac{r}{2B}}\right) 
+ \sqrt{Ar^2 - 2Br}
\end{equation}
All three integrals were computed using \href{https://www.wolframalpha.com/}{Wolfram Alpha}.
\end{enumerate}
